...
let A = new Set(a);
let B = new Set(b);
console.log(a.filter(e => B.has(e)))
...
let numberLanguages = new Set()
for (country of countries_data){
    for(language of country.languages){
        numberLanguages.add(language)
    }
}

console.log(numberLanguages.size)

let popularLanguages = {}
for (country of countries_data){
    for(language of country.languages){
        if(language in popularLanguages){
            popularLanguages[language] += 1
        }else{
            popularLanguages[language] = 1
        }
    }
